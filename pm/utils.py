...
def generate_csv_for_selected_projects(project_ids):
    ...
    writer.writerow([
        'Customer Name', 'Service Description', 'Status', 'Date of Request',
        'Date of Completion', 'Job Completion Certificate', 'Engineer', 'Comment'
    ])
    ...
    for p in projects:
        writer.writerow([
            ...
            p.date_of_completion.strftime('%Y-%m-%d %H:%M') if p.date_of_completion else '',
